    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                <h1 className="text-4xl md:text-6xl mt-4 font-semibold font-ClashDisplay">
                    Sekcja Trójboju Siłowego
                </h1>

                <div className="max-w-5xl p-4">
                    <p className="text-lg mb-6 font-ClashDisplay leading-relaxed text-justify">
                    ...
                    <p className="text-lg font-ClashDisplay leading-relaxed text-justify">

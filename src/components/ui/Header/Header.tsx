...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 xl:top-2 left-0 w-full z-40 bg-hexblack/70 backdrop-blur-lg shadow-lg md:left-1/2 md:transform md:-translate-x-1/2 md:max-w-6xl xl:rounded-lg" role="banner">
